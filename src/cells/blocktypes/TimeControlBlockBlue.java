...
public class TimeControlBlockBlue extends TimeControlBlock{
	public static BufferedImage activeImg;
	public static BufferedImage inactiveImg;
	
	public static void loadImages()
	{
		activeImg = Game.getGame().robustLoadImage("rec/img/blocks/time_blue.png", "Time Control Blue ON");
		inactiveImg = Game.getGame().robustLoadImage("rec/img/blocks/time_blue_off.png", "Time Control Blue OFF");
	}
	@Override
