...
public class TimeControlBlockPurple extends TimeControlBlock{
	...
	public static void loadImages()
	{
		...
		activeImg = Game.getGame().robustLoadImage("rec/img/blocks/time_purple.png", "Time Control Purple ON");
		inactiveImg = Game.getGame().robustLoadImage("rec/img/blocks/time_purple_off.png", "Time Control Purple OFF");
	}
	@Override
