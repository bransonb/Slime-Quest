...
public class TimeControlBlockGreen extends TimeControlBlock{
	public static BufferedImage activeImg;
	public static BufferedImage inactiveImg;
	
	public static void loadImages()
	{
		activeImg = Game.getGame().robustLoadImage("rec/img/blocks/time_green.png", "Time Control Green ON");
		inactiveImg = Game.getGame().robustLoadImage("rec/img/blocks/time_green_off.png", "Time Control Green OFF");
	}
	@Override
